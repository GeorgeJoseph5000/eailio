...
?>
<div class="col-md-9">
<h2>Manage Albums</h2><hr/>
<div class="row">
<?php
		$id = 1;
		$query = mysql_query("SELECT * FROM albums WHERE user='$un'");
		while($row = mysql_fetch_assoc($query)){
		?>
			<div class="col-md-3">
			<div class='panel panel-default' style='width:200px;'>
                <div class='panel-heading'>
				<h4><a href='viewAlbum.php?id=<?php echo $row['id']; ?>' ><?php echo $row['name']; ?></a></h4>
  	    	    </div>
    ...
    <br/>
    <input type="submit" class="btn btn-primary" onclick="addAlbums()" value="Add An Album!!!" />
    </div>
    </div>
